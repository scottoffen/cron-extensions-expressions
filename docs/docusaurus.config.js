...
const config = {
  ...
  projectName: 'cron-extensions-expressions', // Usually your repo name.
    ...
    [
      ...
      ({
        docs: {
          ...
          editUrl:
            'https://github.com/scottoffen/cron-extensions-expressions/edit/main/docs/',
        },
        blog: false,
        theme: {
            ...
            items: [
              {
                ...
                href: 'https://github.com/scottoffen/cron-extensions-expressions/blob/main/.github/contributing.md'
              },
              {
                label: 'Code of Conduct',
                href: 'https://github.com/scottoffen/cron-extensions-expressions/blob/main/.github/code_of_conduct.md'
              },
              {
                label: 'GitHub',
                href: 'https://github.com/scottoffen/cron-extensions-expressions'
