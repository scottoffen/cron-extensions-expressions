...
| `increment` of `0`                                                         | `ArgumentOutOfRangeException` | For minutes and hours it fails because an interval must be greater than `0`; for days and months it fails the field's 1-based range check first. |
