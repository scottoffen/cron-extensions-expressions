...
- Check out the project documentation https://scottoffen.github.io/cron-expressions-extensions.

- Engage in our [community discussions](https://github.com/scottoffen/cron-expressions-extensions/discussions) for Q&A, ideas, and show and tell!
...
We use [SemVer](http://semver.org/) for versioning. For the versions available, see the [tags on this repository](https://github.com/scottoffen/cron-expressions-extensions/releases).
...
Few thing are as satisfying as hearing that your open source project is being used and appreciated by others. Jump over to the discussion boards and [share the love](https://github.com/scottoffen/cron-expressions-extensions/discussions)!
